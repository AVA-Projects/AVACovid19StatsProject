  ...
  return (
    <Navbar className="navbar-expand-xl py-1" variant="dark" expand="lg" sticky="top">
     ...
     {/* <img src={logo} alt='logo' width="45px" height="45x"/>*/}
        ...
        <span>&nbsp;</span>AVA.projects <small className="text-muted"> / <FormattedMessage id="nav_text"></FormattedMessage></small>
        </Link>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto">
            ...
            <Link to='/country/IN' className="nav-link mx-2">
              <FormattedMessage id="country-detail" />
            </Link>
            <Link to="/compare/IN_IT" className="nav-link mx-2">
