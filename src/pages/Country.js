...
const Country = (props) => {
  ...
  useEffect(() => {
    //URL  parametre (props.match.params.id) .
    setLoading(true);
    setCountry(props.match.params.id); //  country  
    setStatsCountry(props.match.params.id); // statsCountry  
  }, [props.match.params.id])


  useEffect(() => {
    setLoading(true); //country 
    getData();
  }, [country]);
  ...
  function updateCountry(updatedCountry) {
    ...
    setStatsCountry(updatedCountry); //statsCountry .
  }
